...
```{r}
coef(hand_picked_add_model_transform)
```
...
-shapiro wilks
-fitted vs residuals
-Call compare function with only that as the input.
...
## Graphs of Selected model performance


- Talk about why it is better to have less 
